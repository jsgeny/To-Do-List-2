"use strict";
//+------------------------------------------------------------------------------+
//| - start -                      12.7.2 To Do List Project                     |
//+------------------------------------------------------------------------------+
(function() {
    ...
    addButton.addEventListener("click", (event) => {
        ...
        if(addText.value !== "") {
            createToDoList();
            tasInput(event, event.target.parentElement.parentElement.children[2].children[0].children[0]);
        }
        taskEditor();
        taskRemove();
        styleChecked(); 
    ...
    function taskEditor() {
        ...
        taskEditorAll.forEach((target) => {
            target.addEventListener("click", (event) => {
                // console.dir(event.target.parentElement.children[1]); // <input[type=text]>
                // - select -
                if(event.target.parentElement.children[1].attributes.disabled) { // disabled = true
                    ...
                    updateLocalStorage();
                } else if(!event.target.parentElement.children[1].attributes.disabled) { // disabled = false
    ...
    //+-----------------------------------------------------------------------+
    document.querySelector(".remove_all_select").addEventListener("click", (event) => {
        const task_add = document.querySelectorAll(".task_add");
        const feedback = document.querySelector(".feedback");
